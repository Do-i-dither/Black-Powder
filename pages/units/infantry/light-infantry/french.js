// pages/units/infantry/light-infantry/french.js
import fs from 'fs';
...
export async function getStaticProps() {
  ...
  return {
    props: {
        unit: infantryStats.Infantry["Light Infantry"].French
    }
  };
}

const FrenchLightInfantry = ({ unit }) => {
    ...
    <div className="card">
      ...
      <div className="content">
        ...
        <div className="imageContainer">
          <img src="/images/infantry/light-infantry/french-light-infantry.jpeg" alt="French Light Infantry" />
        </div>
      </div>
    </div>
  );
...
export default FrenchLightInfantry;
