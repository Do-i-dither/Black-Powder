// pages/units/infantry/grenadiers/british.js
import fs from 'fs';
...
export async function getStaticProps() {
    ...
    return {
        props: {
            unit: infantryStats.Infantry["Grenadiers/95th Rifles"].British
        }
    };
}

const BritishGrenadiersInfantry = ({ unit }) => {
        ...
        <div className="card">
            ...
            <div className="content">
                <div className="stats">
                    ...
                    <p><b>Double Line:</b> {movement["Double Line"]}</p>
                ...
                <div className="imageContainer">
                    <img src="/images/infantry/grenadiers/british-grenadiers.jpeg" alt="British Grenadiers Infantry" />
                </div>
            </div>
        </div>
    );
...
export default BritishGrenadiersInfantry;
